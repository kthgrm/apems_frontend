...
const DeleteCollegeButton = ({ college }: { college: College }) => {
...
const CollegeShow = () => {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Details', href: `/admin/college/${id}` }
    ];
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <Button variant="outline" asChild>
                                <Link to={`/admin/college/${college?.id}/edit`}>
                                    <Edit className="h-4 w-4 mr-2" />
                                    Edit College
                                </Link>
                            </Button>
                            <DeleteCollegeButton college={college!} />
                        </div>
                    </div>
                                            ...
                                            <div className="flex items-center gap-4 p-4 border rounded-lg bg-muted/30">
                                                ...
                                                <div className="overflow-ellipsis">
                                                    ...
                                                    <Button
                                                        ...
                                                        size="sm"
                                                        className="mt-2"
                                                        onClick={() => window.open(asset(college.logo), '_blank')}
                                                    >
                                                        View Full Size
                                                    </Button>
                                                </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        <div className="flex justify-between text-sm">
                                            ...
                                            <div className='flex flex-col items-end'>
                                                <span>{college && college.created_at ? new Date(college.created_at).toLocaleDateString() : '-'}</span>
                                                <span className='text-xs text-stone-500'>
                                                    {college && college.created_at ? new Date(college.created_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : '-'}
                                                </span>
                                            </div>
                                        </div>
                                        <div className="flex justify-between text-sm">
                                            ...
                                            <div className='flex flex-col items-end'>
                                                <span>{college && college.updated_at ? new Date(college.updated_at).toLocaleDateString() : '-'}</span>
                                                <span className='text-xs text-stone-500'>
                                                    {college && college.updated_at ? new Date(college.updated_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : '-'}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
